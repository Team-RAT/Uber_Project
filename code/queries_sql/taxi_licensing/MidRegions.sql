/*Creating a table for the mid sized region taxi license data*/

USE [uber_project]
GO

CREATE TABLE licensing.MidRegions
GO
...
SELECT
      ...
      ,REPLACE(t3.[Column 2], ' 2', '') AS [Licensing Authority Mid Region]
...
INTO licensing.MidRegions
FROM [dbo].[taxi2013] t3
-- inner join tables containing data from all years by LA code
